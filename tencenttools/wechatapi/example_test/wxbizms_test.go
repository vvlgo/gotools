...
func main() {
	token := "OhVhdyBvN"
	receiver_id := "ww6c56e6ec06989628"
	encoding_aeskey := "6XKjZtZwXqI8ZyXY8rHktb7T81jmTsKUpWXW77JRCA6"

	wxcpt := wechatapi.NewWXBizMsgCrypt(token, encoding_aeskey, receiver_id, wechatapi.XmlType)
	/*
		------------使用示例一：验证回调URL---------------
	...
	*/
	...
	verify_msgsig := "c093e376cdf8043c36ca211a10421ffce700bf9b"
	// verify_timestamp := HttpUtils.ParseUrl("timestamp")
	verify_timestamp := "1558574423"
	// verify)nonce := HttpUtils.ParseUrl("nonce")
	verify_nonce := "va7Ojbi2mHAQ8Rkq"
	// verify_echostr := HttpUtils.ParseUrl("echostr")
	verify_echostr := "ByJBWUIJezTaPBTQk80107RDOq%2F92Y8GTGdVMz7OQLREQbyoatX%2BxFpIr2G0I85tJ4J3j%2F%2FONahPraechsPk7Q%3D%3D"
